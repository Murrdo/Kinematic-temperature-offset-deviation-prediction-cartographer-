...
BETA!
Осторожно это не готовое универсальное решение под каждый принтер, написано для себя, требует "допила" под свои окружающие макросы, интеграции в сторовый макрос и т.д.
